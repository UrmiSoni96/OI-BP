...
<body>
    ...
    <div class="container">
        ...
        <?php if(isset($all)){foreach($all as $a) {?>
        ...
        <div class="col-lg-5">
            ...
            <option value="<?php echo $cg->category_id; ?>"<?php if($curr_cgid==$cg->category_id) {?>selected="selected" <?php }?>><?php echo $cg->category_name; ?></option>
            <?php }} ?>
             </select>
        </div></div>
            ...
            <select id="sctg" name="sctg" style="padding: 10px 10px 10px 10px;font-weight: bold;">
                ...
                <div class="form-group " style="margin-left:280px;color:black;font-size:15pt;margin-top:3%;">
                    <label class="col-sm-2 control-label col-lg-2 " for="inputSuccess">Image:*</label>
                        <div class="col-lg-5">
                            <img class="img-responsive" src="<?php if(isset($a->image)) {echo "idea_dp/$a->image"; } else echo "";?>" height="250" width="250" alt="">
                ...
                <div class="form-group " style="margin-left:280px;color:black;font-size:15pt;">
                    <label class="col-sm-2 control-label col-lg-2 " for="inputSuccess">Title:*</label>
                        <div class="col-lg-5">
                            <input type="text" class="form-control" id="title" name="title" value="<?php echo $a->title; ?>">
                            <b id="e1"></b>
                        </div>
                </div>
                ...
                <div class="form-group " style="margin-left:280px;color:black;font-size:15pt;">
                    <label class="col-sm-2 control-label col-lg-2 " for="inputSuccess">Overview:*</label>
                        <div class="col-lg-5">
                            <textarea class="form-control" rows="4" id="ovrvw" name="ovrvw"><?php echo $a->overview; ?></textarea></div>
                </div>
                
                <div class="form-group" style="margin-left:280px;color:black;font-size:15pt;">
                    <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Description:*</label>
                        <div class="col-lg-5">
                            <textarea class="form-control" rows="4" id="dis" name="dis"><?php echo $a->description; ?></textarea>
                         </div> 
                </div>
                ...
                <div class="form-group " style="margin-left:280px;color:black;font-size:15pt;">
                    <label class="col-sm-2 control-label col-lg-2 " for="inputSuccess">Price:*</label>
                        <div class="col-lg-5">
                            <input type="text" class="form-control" id="price" name="price" value="<?php echo $a->price; ?>">
                            <b id="e2"></b>
                        </div>
                </div>
                ...
                <div class="form-group " style="margin-left:280px;color:black;font-size:15pt;">
                    <label class="col-sm-2 control-label col-lg-2 " for="inputSuccess">Resources:*</label>
                        <div class="col-lg-5">
                            <?php if($a->document_name!="") { echo "resource/$a->document_name"; }else { echo ""; } ?>
                ...
                <div class="form-group ">
                    <center>
                        <button type="submit" name="EI_Submit" value="save" class="btn btn-primary"style="background-color: #c43235;border-color: #c43235;">Save</button>
                    </center>
                </div>
            </form>
        <?php }} ?>
